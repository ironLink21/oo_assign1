 ...
 */
class MatchMotherName_BirthDateTest extends GroovyTestCase {
    void testMatchMotherName_BirthDate() {
        ...
        MatchMotherName_BirthDate test = new MatchMotherName_BirthDate();
